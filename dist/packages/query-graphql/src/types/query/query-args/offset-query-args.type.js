...
function createOffsetQueryArgs(DTOClass, opts = { ...constants_1.DEFAULT_QUERY_OPTS, pagingStrategy: paging_1.PagingStrategies.OFFSET }) {
    ...
    tslib_1.__decorate([
        (0, graphql_1.Field)(() => P, {
            defaultValue: { limit: opts.defaultResultSize ?? constants_1.DEFAULT_QUERY_OPTS.defaultResultSize },
            description: 'Limit or page results.'
        }),
        (0, class_validator_1.ValidateNested)(),
        (0, decorators_1.SkipIf)(() => opts.maxResultsSize === -1, (0, class_validator_1.Validate)(property_max_validator_1.PropertyMax, ['limit', opts.maxResultsSize ?? constants_1.DEFAULT_QUERY_OPTS.maxResultsSize])),
