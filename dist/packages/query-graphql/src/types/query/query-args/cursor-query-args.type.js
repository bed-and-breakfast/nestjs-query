...
function createCursorQueryArgsType(DTOClass, opts = { ...constants_1.DEFAULT_QUERY_OPTS, pagingStrategy: paging_1.PagingStrategies.CURSOR }) {
    ...
    const P = (0, paging_1.getOrCreateCursorPagingType)(opts);
    ...
    tslib_1.__decorate([
        ...
        (0, decorators_1.SkipIf)(() => opts.enableFetchAllWithNegative, (0, class_validator_1.Validate)(property_max_validator_1.PropertyMax, ['first', opts.maxResultsSize ?? constants_1.DEFAULT_QUERY_OPTS.maxResultsSize]), (0, class_validator_1.Validate)(property_max_validator_1.PropertyMax, ['last', opts.maxResultsSize ?? constants_1.DEFAULT_QUERY_OPTS.maxResultsSize])),
