import { AggregateQuery, AggregateQueryField, Filter, Paging, Query, SortField } from '@ptc-org/nestjs-query-core';
...
export declare class FilterQueryBuilder<Entity extends Model<Entity, Partial<Entity>>> {
    ...
    applyGroupBy<T extends Groupable>(qb: T, aggregatedGroupBy?: AggregateQueryField<Entity>[]): T;
    applyAggregateSorting<T extends Sortable>(qb: T, aggregatedGroupBy?: AggregateQueryField<Entity>[]): T;
